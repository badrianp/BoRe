...
<body>
    <div class="loginDiv" id="loginDiv">
        ...
        <form action="LogInDatabase.php" id="div1" class="cardDiv1">

            <p id="welcomeText" class="" id="Item1">Welcome to BoRe!</p>
            <input type="email" class="labelItem" id="email" name="email" placeholder="email">
            <input type="password" class="labelItem" id="password" name="password" placeholder="password">
        ...
        <div id="div2" class="cardDiv2">
            ...
            <button type="button" id="guestLoginButton" onclick="window.location.href='Home.php';" class="button">guest</button>
        </div>
